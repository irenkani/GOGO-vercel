...
import { loginUser } from '../Home/api.tsx';
...
function LoginPage() {
    ...
    type ValueType = keyof typeof defaultValues;
    ...
    async function handleSubmit() {
        if (validateInputs()) {
            loginUser(values.email, values.password)
                .then((user) => {
                    console.log('navigating to album-upload!');
                    dispatchUser(
                        user.email!,
                        user.firstName || '',
                        user.lastName || '',
            ...
            <FormGrid>
                <FormCol>
                    <Grid item container justifyContent="center">
                        <Typography variant="h2" textAlign="center" sx={{ color: 'white', mb: 3 }}>
                            Welcome, Admin!
                        </Typography>
                    </Grid>
                    <Grid item width="1">
